        ...
        <div>
            ...
            <Modal show={show1} scrollable={true} size={'xl'} onHide={() => setShow1(false)}>
                <Modal.Header closeButton>
                    <center><Modal.Title>Counsellor Project</Modal.Title></center>
                </Modal.Header>
                <Modal.Body>
                    <div >
                        <h6><center><b>Technologies used</b><br />
                            <b>Frontend : </b>Html, CSS, Bootstrap, React JS<br />
                            <b> Backend:</b> Node.js,Python<br />
                            <b> Deployment: </b>AWS Cloud Services<br />
                            <b>Code Versioning Systems:</b> Git and GitHubS</center></h6>
                        <p>
                            <b>Sprint 1:</b> Learnings
                            <br />
                            <div className="row">
                                <div className="column">
                                    <img src="scrum.png" alt="Snow" />
                                </div>
                                <div class="column">
                                    <img src="Git.png" alt="Forest" />
                                </div>
                                <div class="column">
                                    <img src="balsemiq.png" alt="Mountains"/>
                                </div>
                            </div>
                            <br/>
                            {/* <img src="scrum.png" alt=""/> <img src="" alt=" jj"/> */}
                            <ul>
                                <li>Learned about the SCRUM methodology</li>
                                <li>Decided on what technologies are needed to develop the Web Application</li>
                                <li>Learned how to create the User stories and branches in GitHub</li>
                                <li>Also learned how to write Acceptance criteria for a user Story</li>
                                <li> Developed a user stories and prototype using Balsamiq Cloude </li>
                            </ul>
                            <br/><br/>
                            <b>Sprint 2:</b> Learnings
                            <br/><br/>
                            <div className="row">
                                <div className="column">
                                    <img src="studentData.png" alt="Snow" />
                                </div>
                            </div><br/>
                            <ul>
                                <li>Started implementing the User story 1 which is to create a Student and counsellor page</li>
                                <li>Created the User Interface using React JS</li>
                                <li>Created a database in DyamoDB and connected Lambda functions and Database using Python and  and Node</li>
                                <li>Implemented UI for Admin page for Student, Counsellor.</li>
                            </ul>
                            <br /><br />
                            <b>Sprint 3:</b> Learnings<br/><br/>
                            <div className="row">
                                <div className="column">
                                    <img src="spreadSheet.jpg" alt="Snow" />
                                </div>
                                <div className="column">
                                    <img src="sortf.JPG" alt="Snow" />
                                </div>
                            </div><br/>
                            <ul>
                                <li>Started implementing the User story 1 which is to create a Frontend for Admin</li>
                                <li>Created the User Interface using React JS</li>
                                <li>Created a UI to show the data of uploaded CSV file</li>
                                <li>I have developed the UI part for user story1, 2. Tried to implement the backend part to the project.</li>
                                <li></li>
                            </ul>
                            <br /><br />
                            <b>Sprint 4:</b> Learnings<br/><br/>
                            <div className="row">
                                <div className="column">
                                    <img src="aws.png" alt="Snow" />
                                </div>
                            </div>
                            <br/>
                            <ul>
                                <li>Learnt about AWS Cloud services.</li>
                                <li>Created the User Interface using React JS</li>
                                <li>Worked on AWS Unicorn project to know about all the functionality that are required for Counsellor Project</li>
                                <li>Created a database in DynamoDB and connected UI and Database using Node.js using lambda functions.</li>
                            </ul>
                            <br /><br />
                            <b>Sprint 5:</b> Learnings<br/>
                            <div className="row">
                                <div className="column">
                                    <img src="api.png" alt="Snow" />
                                </div>
                                
                            </div>
                            <br/>
                            <ul>
                                <li>Worked on API gate way. Connected Lambda functions to react.js APP through API gateway</li>
                                <li>Faced CORS issue</li>
                                <li>was able to connect the lambda funcions to API gateway</li>
                                <li>Able to perform CRUD operations using API gateway</li>
                            </ul>
                            <br /><br />
                            <b>Sprint 6:</b> Learnings<br/>
                            <div className="row">
                                <div className="column">
                                    <img src="Google-Auth.png" alt="Snow" />
                                </div>
                                <div className="column">
                                    <img src="Login.png" alt="Snow" />
                                </div>
                                <div className="column">
                                    <img src="Logout.png" alt="Snow" />
                                </div>
                            </div>
                            <br/>
                            <ul>
                                <li>Implemented Google authentication by genrating a client ID using MSIT domain</li>
                                <li>Implemented Login and Logout actions</li>
                                <li>Implemented UI for landing page</li>
                                <li>Implemented logic for redirecting to a page based on roles(i.e; student, counsellor, admin)</li>
                            </ul>
                            <br /><br />
                            <b>Sprint 7:</b> Learnings<br/>
                            <div className="row">
                                <div className="column">
                                    <img src="alert.JPG" alt="Snow" />
                                </div>
                            </div>
                            <br/>
                            <ul>
                                <li>Implemented the logic to clean the CSV data</li>
                                <li>Implemented to show an alert if the Admin uploads the existing batch</li>
                                <li> Wrorked on deactivating the batch after the completion of the academic year</li>
                            </ul>

                            <br /><br />
                            <b>Sprint 8:</b>  Learnings
                            <br/>
                            <div className="row">
                                <div className="column">
                                    <img src="awsdeploy.png" alt="Snow" />
                                </div>
                                
                            </div>
                            <br/>
                            <ul>
                                <li>Deploying the Web Application</li>
                                <li>Sending an email using google API</li>
                                <li>Shown the status of counsellor avialable slots and fixed meetings</li>
                            </ul>
                        </p>
            ...
            <Modal show={show2} scrollable={true} size={'xl'} onHide={() => setShow2(false)}>
                ...
                <Modal.Body><Row className="Container">
        <Col></Col>
        <Col sm={11}>
